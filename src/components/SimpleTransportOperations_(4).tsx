      ...
      <div style={containerStyle}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          ...
          <button
            ...
            onClick={() => { setShowTransferForm(true); setTfOrigin(''); setTfDestination(''); setTfDepartureAt(''); setTfServiceMode(''); setTfDriverName(''); setTfDriverPhone(''); setTfVehicleType(''); setTfVehicleCapacity(''); setTfError('') }}
            disabled={disabled}
          >
            + Nuovo transfer
          </button>
