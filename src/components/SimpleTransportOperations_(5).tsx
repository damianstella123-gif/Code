      ...
      <div style={containerStyle}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          ...
          <button
            ...
            onClick={() => { setShowTransferForm(true); setEditingMovement(null); setTfOrigin(''); setTfDestination(''); setTfDepartureAt(''); setTfServiceMode(''); setTfDriverName(''); setTfDriverPhone(''); setTfVehicleType(''); setTfVehicleCapacity(''); setTfError('') }}
            disabled={disabled}
          >
            + Nuovo transfer
          </button>
          ...
          <div style={inlineFormStyle}>
            ...
            <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
                ...
                onClick={async () => {
                  ...
                  try {
                    if (editingMovement) {
                      ...
                      setTfOrigin(''); setTfDestination(''); setTfDepartureAt(''); setTfServiceMode('')
                      setTfError('')
                      await loadMovements()
                      return
                    }
              ...
              <button
                ...
                onClick={() => { setShowTransferForm(false); setEditingMovement(null) }}
                disabled={savingTransfer}
              >
                Annulla
              </button>
                  ...
                  <div style={cardMetaStyle}>
                    ...
                    {m.service_mode && (
                      <span style={{
                        ...
                        {m.service_mode === 'disposizione' ? 'A disposizione' : 'A tratta'}
                      </span>
                    )}
                  </div>
                  {m.drivers.length > 0 && (
