...
// La verifica in due passaggi e obbligatoria per tutti i ruoli: Synergy contiene
// dati personali dei partecipanti e informazioni economiche dei clienti.
export const ROLES_REQUIRING_MFA = ['Super Admin', 'Admin'] as const
// Tolleranza breve: il tempo di installare l'app di autenticazione, non di piu.
export const MFA_GRACE_DAYS = 2
export const MFA_MAX_SKIPS = 1
