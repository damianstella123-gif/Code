...
INSERT INTO clients (id, name, company, email, phone, notes) VALUES
  ('cli_001','TechnoCorp Industries','Tecnologia','events@technocorp.com','+39 02 6789 0123','Cliente storico, rinnovo annuale.'),
  ('cli_002','VisionGames Entertainment','Gaming','pr@visiongames.com','+39 06 5432 1098','Espansione eventi live per il 2027.'),
  ('cli_003','Cucina d''Italia Group','Food & Beverage','marketing@cucinaditalia.it','+39 055 8765 4321','Proposta per festival 2027.'),
  ('cli_004','EcoGreen Solutions','Sostenibilita','partnership@ecogreen.eu','+39 02 3456 7890','Focus su eventi eco-sostenibili.'),
  ('cli_005','Fondazione Hope','Non-Profit','eventi@fondazionehope.org','+39 02 9876 5432','Gala annuale di beneficenza.'),
  ('cli_006','PharmaLife','Farmaceutica','congressi@pharmalife.com','+39 06 2345 6789','Congressi medici annuali.'),
  ('cli_007','LuxeAuto Milano','Automotive','press@luxeauto.it','+39 02 4567 8901','Lanci prodotto esclusivi.'),
  ('cli_008','Fashion Week Italia','Moda','events@fashionweekitalia.com','+39 02 5678 9012','Partnership pluriennale.'),
  ('cli_009','SportEvents Pro','Sport','org@sporteventspro.it','+39 041 1234 5678','Tornei e gala sportivi.'),
  ('cli_010','Art&Culture Foundation','Arte','info@artculturefoundation.org','+39 06 6789 0123','Contatto iniziale.'),
  ('cli_011','GlobalTrade Expo','Fiere','fairs@globaltrade.it','+39 02 7890 1234','Da riaprire nel Q3 2027.'),
  ('cli_012','MediaGroup Italia','Media','events@mediagroup.it','+39 06 3456 7890','Da ricontattare fine anno.')
