...
CREATE POLICY "anon_select_admin_documents" ON admin_documents FOR SELECT TO anon, authenticated USING (true);
DROP POLICY IF EXISTS "anon_insert_admin_documents" ON admin_documents;
CREATE POLICY "anon_insert_admin_documents" ON admin_documents FOR INSERT TO anon, authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "anon_update_admin_documents" ON admin_documents;
CREATE POLICY "anon_update_admin_documents" ON admin_documents FOR UPDATE TO anon, authenticated USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS "anon_delete_admin_documents" ON admin_documents;
CREATE POLICY "anon_delete_admin_documents" ON admin_documents FOR DELETE TO anon, authenticated USING (true);
